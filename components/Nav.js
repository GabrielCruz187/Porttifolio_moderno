...
const Nav = () => {
  ...
  bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen'>
    ...
    xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-80 bg-red-200/10 xl:h-max py-8 bg-white/10
    backdrop-blur-sm text-3xl xl:text-x1 xl:rounded-full'>
          ...
          <div className='absolute pr-14  right-0  hidden xl:group-hover:flex '>
            ...
            [6px] rounded-[3px'>
              <div className='text-[12px]'>
                ...
                {/*triangle*/}
                <div className='border-solid border-l-whithe border-l-8
