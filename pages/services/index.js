      ...
      <div className='flex flex-col xl:flex-row gap-x-8'>
        ...
        <div className='text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0'>
          ...
          <motion.p variants={fadeIn('up', 0.4)} initial="hidden" animate="show"
            exit="hidden" className='mb-4 max-w-[400px] mx-auto lg:mx-0'>Ofereço soluções completas e personalizadas em desenvolvimento web, desde a criação de interfaces intuitivas até a implementação de sistemas robustos no backend. Meu foco é transformar ideias em ferramentas digitais eficientes, com alta performance e design funcional.</motion.p>
        </div>
          {/* slider */}
